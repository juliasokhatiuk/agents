...
You MUST use at least one of the available tools (`web_search`, `knowledge_search`) for a brief preliminary search to understand the domain, clarify the topic, and identify the most relevant directions for deeper research.
